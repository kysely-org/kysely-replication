...
Consumer-facing APIs are documented using [JSDoc](https://jsdoc.app/) comments in the source code @ [/src](https://github.com/kysely-org/kysely-replication/tree/main/src).
If you need to change or add documentation, please do so in these comments.
...
- Should work in all JavaScript environments (node.js, deno & modern browsers),
...
1. write tests @ [/test/\*](https://github.com/kysely-org/kysely-replication/tree/main/test).
